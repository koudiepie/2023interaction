...
void mousePressed(){
  ...
  if(state==2){
    if(testInside(50,360,200,200)) { state=3; MainMain = Main4; }//MainMain玩家選擇的角色
    if(testInside(300,360,200,200)) { state=3; MainMain = Main3; }
    if(testInside(550,360,200,200))  { state=3; MainMain = Main5; }
    if(testInside(800,360,200,200))  { state=3; MainMain = Main; }
    if(testInside(1050,360,200,200))  { state=3; MainMain = Main2; }
    if(testInside(50,60,200,200))  { state=3; MainMain = Main7; }
    if(testInside(300,60,200,200))  { state=3; MainMain = Main9; }
    if(testInside(550,60,200,200))  { state=3; MainMain = Main10; }
    if(testInside(800,60,200,200))  { state=3; MainMain = Main6; }
    if(testInside(1050,60,200,200))  { state=3; MainMain = Main8; }
    BGM = true;
