...
void draw(){
  if(state==0){
    ...
    background(0);
    image(Main4,50,360,200,200);
    image(Main3,300,360,200,200);
    image(Main5,550,360,200,200);
    image(Main,800,360,200,200);
    image(Main2,1050,360,200,200);
  }
  else if(state==2){
    second++;
